# This will generate a list of linking verbs that can be used to build segments
filter_verbs <- data.frame(rbind(
...
colnames(filter_verbs) <-  c('type', 'class', 'verb', 'description')
...
readr::write_csv(filter_verbs, "data-raw/filter_verbs.csv")
readr::write_csv(filter_verbs, "inst/extdata/filter_verbs.csv")

usethis::use_data(filter_verbs, overwrite = TRUE)
