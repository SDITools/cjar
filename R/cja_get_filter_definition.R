#' Get a list of all filter definitions in CJA
#'
#' Retrieves a paginated list of filter definitions, also known as `segments` in Adobe Analytics.
#'
...
#' @examples
#' \dontrun{
#' cja_get_filter_defintions()
#' }
#' @export
#' @import assertthat httr
#' @importFrom purrr map_df
#'
cja_get_filter_definitions <- function(expansion = 'definition',
                                       includeType = 'all',
                                       dataIds = NULL,
                                       ownerId = NULL,
                                       filterByIds = NULL,
